...
const reports = [
  {
    ...
    preview: "https://r.jina.ai/https://example.com/report-financial", // 模拟预览效果
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {reports.map((report, index) => (
            <motion.div
              ...
              className="group relative flex flex-col bg-slate-900/40 border border-slate-800 rounded-3xl overflow-hidden hover:border-emerald-500/30 transition-all duration-500"
            >
              ...
              <div className={cn("aspect-video relative overflow-hidden bg-gradient-to-br", report.accent)}>
                <div className="absolute inset-0 flex items-center justify-center group-hover:scale-105 transition-transform duration-700">
                  <div className="w-3/4 h-2/3 bg-slate-950/80 rounded-lg border border-white/5 shadow-2xl p-4 overflow-hidden">
                    ...
                    <div className="mt-6 flex gap-2">
                       <div className="flex-1 h-12 bg-emerald-500/10 rounded-md border border-emerald-500/10" />
                       <div className="flex-1 h-12 bg-blue-500/10 rounded-md border border-blue-500/10" />
                    </div>
                  </div>
                </div>
